<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\phpStudy\WWW\mall\public/../application/admin\view\floor\floor_edit.html";i:1585905596;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body class="layui-view-body">
    <form class="layui-form" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="layui-row">
                ...
                <div class="layui-card-header">添加轮播</div>
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="text" name="title" value="<?php echo $floorEdit['title']; ?>" placeholder="请输入标题" autocomplete="off" class="layui-input">
                    </div>
                  </div>
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block" style="position: relative">
                        ...
                        <table style="width:102px;height:102px;border:1px solid #e6e6e6" id="localImag">
                            <tr>
                                <td>
                                    <?php if($floorEdit['image']): ?>
                                    <img  id="preview" alt="" src="/uploads/<?php echo $floorEdit['image']; ?>" style="width: 100px;">
                                    <?php else: ?>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <select name="link_type" lay-filter="sfilter">
                            ...
                            <option <?php if($vo['id']==$floorEdit['link_type']): ?>selected<?php endif; ?> value="<?php echo $vo['id']; ?>" url="<?php echo $vo['router']; ?>" type="<?php echo $vo['type']; ?>"><?php echo $vo['title']; ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>

                    </div>
                    <div class="layui-input-inline selectShop" <?php if($floorEdit['type']==1): ?> style="display: block;" <?php else: ?> style="display: none;" <?php endif; ?>>
                    <button data-method="setTop" class="layui-btn layui-btn-blue " type="button" style="margin-bottom:0;">选择商品</button>
                </div>

            </div>
            <div class="layui-form-item urlAddress" <?php if($floorEdit['type']==2): ?> style="display: block;" <?php else: ?> style="display: none;" <?php endif; ?>>
            <label class="layui-form-label">链接地址</label>
            <div class="layui-input-block">
                <input type="type" name="link2" value="<?php echo $floorEdit['link']; ?>"  placeholder="请输入链接地址" autocomplete="off" class="layui-input inputUrl">
            </div>
            ...
            <div class="layui-form-item type1Address" <?php if($floorEdit['type']==1): ?> style="display: block;" <?php else: ?> style="display: none;" <?php endif; ?>>
            <label class="layui-form-label">链接地址</label>
            <div class="layui-input-block">
                <input type="type" value="<?php echo $floorEdit['link']; ?>" name="link1"  placeholder="请输入链接地址" autocomplete="off" class="layui-input selectShopUrl">
            </div>
    ...
    <script>
        ...
        var router="<?php echo $floorEdit['router']; ?>"
    </script>
