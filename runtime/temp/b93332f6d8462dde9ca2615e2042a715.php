<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"E:\phpstudy\PHPTutorial\WWW\mall\public/../application/admin\view\iconlist\icon_list.html";i:1578044451;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    <div class="form-box">
                        ...
                        <a class="layui-btn layui-btn-blue" href="<?php echo url('Iconlist/add'); ?>"><i class="layui-icon">&#xe654;</i>新增</a>
                        <table class="layui-table">
                            ...
                            <tbody>
                            <?php if(is_array($icon) || $icon instanceof \think\Collection || $icon instanceof \think\Paginator): $i = 0; $__LIST__ = $icon;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    ...
                                    <td>
                                            <a href="<?php echo url('Iconlist/edit',array('id'=>$vo['id'])); ?>" class="layui-btn layui-btn-xs layui-btn-blue">编辑</a>
                                            <a href="<?php echo url('Iconlist/del',array('id'=>$vo['id'])); ?>" class="layui-btn layui-btn-xs layui-btn-danger">删除</a>
                                    </td>
                                </tr>
