<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"/Applications/MAMP/htdocs/mall/public/../application/admin/view/link/link_list.html";i:1585811965;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    <div class="form-box">
                        ...
                        <a class="layui-btn layui-btn-blue" href="<?php echo url('Link/add'); ?>"><i class="layui-icon">&#xe654;</i>新增</a>
                        <table class="layui-table">
                            ...
                            <?php if(is_array($link) || $link instanceof \think\Collection || $link instanceof \think\Paginator): $i = 0; $__LIST__ = $link;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if($vo['type']==1): ?>弹窗<?php endif; if($vo['type']==2): ?>表单<?php endif; ?>
                                    </td>
                                    <td>
                                            <a href="<?php echo url('Link/edit',array('id'=>$vo['id'])); ?>" class="layui-btn layui-btn-xs layui-btn-blue">编辑</a>
                                            <a href="<?php echo url('Link/del',array('id'=>$vo['id'])); ?>" class="layui-btn layui-btn-xs layui-btn-danger">删除</a>
                                    </td>
                                </tr>
