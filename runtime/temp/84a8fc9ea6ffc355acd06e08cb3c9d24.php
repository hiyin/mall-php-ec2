<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\phpStudy\WWW\mall\public/../application/admin\view\order\order_list.html";i:1585210406;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<!--                                <col width="200">-->
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($vo['paytype']==1): ?>支付宝<?php endif; if($vo['paytype']==2): ?>微信<?php endif; if($vo['paytype']==''): ?>待支付<?php endif; ?>
                                    </td>
                                    <td>
