<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:98:"E:\phpstudy\PHPTutorial\WWW\mall\public/../application/admin\view\product\product_service_add.html";i:1574230258;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-card">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="title"  placeholder="请输入服务名称" autocomplete="off" class="layui-input">
                    </div>
                </div>
