<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"E:\phpstudy\PHPTutorial\WWW\mall\public/../application/admin\view\banner\banner_edit.html";i:1547004520;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                ...
                <div class="layui-card-header">添加轮播</div>
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                      <input type="type" name="link" value="<?php echo $bannerEdit['link']; ?>"  placeholder="请输入链接地址" autocomplete="off" class="layui-input">
                    </div>
